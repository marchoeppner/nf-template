...
workflow {
    ...
    workflow.onComplete {
        ...
        emailFields['runName'] = params.run_name
        ...
        def emailText = txtTemplate.toString()
        ...
        def subject = "Pipeline finished (${params.run_name})."
        ...
        if (params.email) {
            ...
            def smailFields = [ email: params.email, subject: subject, emailText: emailText,
            ...
            try {
                if (params.plaintext_email) {  new org.codehaus.groovy.GroovyException('Send plaintext e-mail, not HTML') }
